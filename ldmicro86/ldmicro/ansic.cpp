...
{
	// ldmicro86: change STATIC SWORD to static short
    fprintf(f, "static short %s = 0;\n", str);
}
...
static void DeclareBit(FILE *f, char *str)
{
    ...
    if(str[4] == 'X') {
		...
		*/
		...
		// ldmicro86: change STATIC BOOL to static bool
...
void CompileAnsiC(char *dest)
{
	...
	// ldmicro86: define Output and Input pins.
	fprintf(f,
"/* Output pins. */\n"
"#define PLC_Y0 (0)\n"
"#define PLC_Y1 (1)\n"
...
"#define PLC_X3 (7)\n\n"
	...
	// ldmicro86: input and output Vector declare
	fprintf(f,
"bool inputVector[4] = {\n"
...
"};\n\n"
	...
	//ldmicro86: updateInput function define
	fprintf(f,
"void updateInput()\n"
"{\n"
"\tinputVector[0] = digitalRead(PLC_X0);\n"
"\tinputVector[1] = digitalRead(PLC_X1);\n"
"\tinputVector[2] = digitalRead(PLC_X2);\n"
"\tinputVector[3] = digitalRead(PLC_X3);\n"
"}\n\n"
		);

	//ldmicro86: updateOutput function define
	fprintf(f,
"void updateOutput()\n"
"{\n"
"\tdigitalWrite(PLC_Y0, outputVector[0]);\n"
"\tdigitalWrite(PLC_Y1, outputVector[1]);\n"
"\tdigitalWrite(PLC_Y2, outputVector[2]);\n"
"\tdigitalWrite(PLC_Y3, outputVector[3]);\n"
"}\n\n"
		);
	//ldmicro86: read/write input/output vector functions
	fprintf(f,
"bool Read_U_b_X0()\n"
"{\n"
...
"bool Read_U_b_Y1()\n"
"{\n"
"\treturn outputVector[1];\n"
"}\n\n"
"bool Read_U_b_Y2()\n"
"{\n"
"\treturn outputVector[2];\n"
"}\n\n"
"bool Read_U_b_Y3()\n"
"{\n"
"\treturn outputVector[3];\n"
"}\n\n"
...
"}\n\n"
	...
	// ldmicro86: comment the file discription
/*
    fprintf(f,
...
"   program. I_xxx symbols are internally generated. *\n"
	...
	*/
	...
	// ldmicro86: comment PLC cycle discription
...
"{\n"
	...
	// ldmicro86:  Add setup and loop function
	fprintf(f,
"long timeCycle = millis();\n\n"
"void setup()\n"
"{\n"
"\tpinMode(PLC_Y0, OUTPUT);\n"
"\tpinMode(PLC_Y1, OUTPUT);\n"
"\tpinMode(PLC_Y2, OUTPUT);\n"
"\tpinMode(PLC_Y3, OUTPUT);\n"
"\tpinMode(PLC_X0, INPUT);\n"
"\tpinMode(PLC_X1, INPUT);\n"
"\tpinMode(PLC_X2, INPUT);\n"
"\tpinMode(PLC_X3, INPUT);\n"
"}\n\n"
"void loop()\n"
"{\n"
"\ttimeCycle = millis();\n"
...
"}\n"
	...
	sprintf(str, _("Please wait until LDmicro86 Ladder compiles your code and send it to the PLC"));
	/*
