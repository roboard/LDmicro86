...
#define LDMICRO_PATTERN "LDmicro86 Ladder Logic Programs (*.ld)\0*.ld\0" \
                     "All files\0*\0\0"
...
// ldmicro86:	ino pattern define
#define INO_PATTERN "86duino Source Files (*.ino)\0*.ino\0All files\0*\0\0"
...
static void CompileProgram(BOOL compileAs)
{
	...
	// ldmicro86: change 50000 to 10000
	Prog.cycleTime = 10000; //defines the cycle time to 10ms
	// ldmicro86: change cpp to ino
    sprintf(CurrentCompileFile, _("Core\\arduino\\libraries\\Ladder\\Ladder.ino"));
	if(compileAs || strlen(CurrentCompileFile)==0) {
        ...
        if(Prog.mcu && Prog.mcu->whichIsa == ISA_ANSIC) {
            // ldmicro86: change default file type from C to INO
			ofn.lpstrFilter = INO_PATTERN;
			ofn.lpstrDefExt = "ino";
	...
	// ldmicro86: comment CreateProcess code
	/*
...
BOOL CheckSaveUserCancels(void)
{
    ...
    int r = MessageBox(MainWindow, 
        ...
        "Do you want to save the changes?"), "LDmicro86 Ladder",
...
LRESULT CALLBACK MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    switch (msg) {
        ...
        case WM_KEYDOWN: {
            ...
            switch(wParam) {
                case VK_F5:
					// ldmicro86: change parameter FALSE to TRUE
                    CompileProgram(TRUE);
                    break;
    ...
    LPSTR lpCmdLine, INT nCmdShow)
{
    ...
    if(memcmp(lpCmdLine, "/c", 2)==0) {
        ...
        *dest = '\0'; dest++;
        ...
        GenerateIoList(-1);
		// ldmicro86: comment CompileProgram(FALSE)
       // CompileProgram(FALSE);
        exit(0);
    }
